  ...
  <div class="min-h-screen pl-2 bg-gray-950 text-white">
    <div class="flex flex-col h-svh justify-center items-center">
      ...
      <div class="flex flex-col mt-8 w-56">
        <input
          type="email"
          class="p-2 bg-transparent text-white border border-gray-800 rounded-lg"
          placeholder="email"
          @input="error = ''"
          v-model="email"
        />
        <input
          type="password"
          class="p-2 mt-2 bg-transparent text-white border border-gray-800 rounded-lg"
