<template>
    <div class="min-h-[calc(100vh-4.5rem)] pl-2 text-white">
        <div class="flex flex-col h-svh justify-center items-center">
            <h1
                class="text-3xl text-transparent bg-linear-to-tr from-[#24c7ce] to-[#1ed794] bg-clip-text font-extrabold"
            >
                faser register
            </h1>
            ...
            <div class="flex flex-col mt-8 w-56">
                ...
                <p class="text-sm text-center text-gray-500 mb-2">
                    ...
                    <RouterLink to="/tos" class="underline"
                ...
                <div class="mt-12">
                    <div
                        v-show="error"
                        class="bg-[#220000] border border-red-700 rounded-md w-56 text-center py-8"
                    >
                        <p>{{ error }}</p>
                    </div>
                </div>
