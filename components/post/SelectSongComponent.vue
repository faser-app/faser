<template>
    <BaseModalComponent :isOpen="props.showModal" @close="$emit('close')" title="Select Song" icon="music"
        iconBgColor="green-950" iconBorderColor="green-600" :error="error" customClass="max-h-[80svh] overflow-scroll"
        animationDirection="bottom" submitText="Submit" @submit="$emit('selectSong', selectedTrack)"
