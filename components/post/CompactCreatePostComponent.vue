<template>
  <div class="compact-create-post" :class="{ 'expanded': isExpanded }"
    ...
    <div class="post-container">
      ...
      <div class="user-avatar">
        <img v-if="haveProfilePicture && loaded" @error="haveProfilePicture = false"
          :src="'https://s3.faser.app/profilepictures/' + ownProfile.id + '/image.png' + '?t=' + new Date().getTime()"
          class="h-10 w-10 rounded-full object-cover" alt="Profile" />
        <div v-else
          class="h-10 w-10 rounded-full flex items-center justify-center border border-[#96969627] bg-[#1118276c]">
      ...
      <div class="post-input-area" :class="{ 'expanded': isExpanded }">
        <div class="input-wrapper" @click="expandInput">
          <textarea ref="postTextarea" class="post-textarea" :class="{ 'expanded': isExpanded }"
            :style="{ backgroundColor: currentPalette.bg }" v-model="postContent" placeholder="What's happening?"
            @focus="expandInput" @blur="checkForCollapse" @input="checkContentLength"></textarea>
        </div>
        ...
        <div v-if="isExpanded" class="media-options">
          <div class="selected-media">
            <div v-if="selectedTrack">
              ...
              <iframe :src="'https://open.spotify.com/embed/track/' + selectedTrack.songId" class="spotify-embed"
                frameBorder="0" allowfullscreen="" allow="clipboard-write; encrypted-media;"></iframe>
            </div>
          ...
          <div class="action-buttons">
            ...
            <div class="option-button" :style="{ backgroundColor: currentPalette.buttonSecondary }"
            ...
            <div v-if="isAdult" class="option-toggle">
              <label class="switch-label">
                ...
                <span class="toggle-slider"
                  :style="{ backgroundColor: nsfw ? currentPalette.buttonPrimary : currentPalette.buttonSecondary }"></span>
            ...
            <div class="option-toggle">
              <label class="switch-label">
                ...
                <span class="toggle-slider"
                  :style="{ backgroundColor: ai ? currentPalette.buttonPrimary : currentPalette.buttonSecondary }"></span>
        ...
        <div v-if="isExpanded" class="post-actions">
          ...
          <button class="post-button" :disabled="postContent.length === 0 || postContent.length > 300 || loading"
            :style="{ 
  ...
  <PostSelectSongComponent :show-modal="searchSong" @close="searchSong = false" class="z-50" @selectSong="selectSong" />
</template>
