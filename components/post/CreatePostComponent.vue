    ...
    <transition name="fade" @leave="leave">
        <div
            ...
            :class="{
                fadeIn: showModal,
                'backdrop-blur-xl':
                    !props.mobile !== undefined ? props.mobile : false,
            }"
        >
            <div
                class="w-full flex justify-center h-fit"
                :class="{
                    animation: showModal,
                    fadeOut: !showModal,
                }"
            >
                <div
                    class="md:w-4/5 w-full md:mx-0 mx-2 p-3 rounded-md"
                ...
                >
                    <div class="flex">
                        ...
                        <div
                            @click="closeModal"
                            class="flex cursor-pointer justify-end text-xl mr-1"
                        >
                    ...
                    >
                        <textarea
                            class="w-full h-40 text-white pt-0 mt-2 resize-none focus:outline-hidden"
                            :style="{
                                backgroundColor: currentPalette.buttonPrimary,
                            }"
                            v-model="postContent"
                        ...
                        <div v-if="selectedTrack">
                            <div
                                class="flex absolute w-8 h-8 justify-center items-center p-2 rounded-md cursor-pointer"
                                :style="{
                                    backgroundColor:
                                        currentPalette.buttonDanger,
                                }"
                            ...
                            <iframe
                                ...
                                :src="
                                    ...
                                    selectedTrack.songId
                                "
                                class="md:w-96 w-full mb-2"
                                width="100%"
                                height="80rem"
                                frameBorder="0"
                                allowfullscreen=""
                        ...
                        <div class="flex gap-2">
                            <div
                                ...
                                :style="{
                                    backgroundColor:
                                        currentPalette.buttonSecondary,
                                }"
                                @click="selectFile"
                            >
                                <i
                                    class="fa-solid fa-image text-2xl overflow-visible"
                                ></i>
                            </div>
                            <div
                            ...
                            >
                                <i
                                    class="fa-solid fa-music text-2xl overflow-visible"
                                ></i>
                            </div>
                        </div>
                    ...
                    <div
                        class="flex md:flex-nowrap flex-wrap justify-end mt-2 gap-2"
                    >
                        <button
                            @click="closeModal"
                            class="p-2 md:w-2/3 w-full rounded-md"
                            :style="{
                                backgroundColor: currentPalette.buttonPrimary,
                            }"
                        >
        ...
        .then((response) => {
            ...
            if (images.value.length > 0) {
                for (let i = 0; i < images.value.length; i++) {
                    ...
                    axios
                        .post(baseURL + '/api/social/uploadImage', formData, {
                            headers: {
...
.fadeIn {
    animation: fadeInOpacity 0.3s cubic-bezier(0.6, 0, 0.4, 1);
}
