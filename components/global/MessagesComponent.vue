<template>
    <div class="text-white w-full overflow-auto p-2 rounded-md">
        ...
        <div
            ...
            class="w-full text-gray-400 italic flex items-center justify-center h-28"
        >
            <p>Great! You have no new messages</p>
        </div>
        <div v-else v-for="(message, index) in messages" :key="message">
            <div
                v-if="message.type === 'like' || message.type === 'comment'"
                class="flex pb-2 mb-2"
                :class="{
            ...
            >
                <div class="h-full items-center">
                    <div
                        class="flex justify-center items-center w-8 h-8 bg-gray-700 rounded-full mr-2"
                    >
                        <div
                ...
                <div>
                    <div class="flex w-full items-center">
                        <RouterLink
                            ...
                            :to="'/' + message.userProfile[0].username"
                            class="flex"
                        >
                            <p class="flex">
                                {{ message.userProfile[0].displayName }}
                            </p>
                            <p class="text-gray-400">
                                (@{{ message.userProfile[0].username }})
                            </p>
                            <div
                                v-if="message.userProfile[0].businessAccount"
                            ...
                            <div
                                v-else-if="
                                    message.userProfile[0].verifiedAccount
                                "
                    ...
                    >
                        <div class="flex">
                            ...
                            <p class="text-gray-400 mr-1" v-else>
            ...
            >
                <div class="h-full items-center">
                    <div
                        class="flex justify-center items-center w-8 h-8 bg-gray-700 rounded-full text-sky-300 mr-2"
                    >
            ...
            >
                ...
                <div>
                    <RouterLink
                        @click="closeUserMessages"
                        :to="'/messages/' + message.userProfile[0].id"
                    >
                        <div class="flex w-full items-center">
                            <p class="flex">
                                {{ message.userProfile[0].displayName }}
...
const emit = defineEmits(['closeMessages', 'clearMessages'])

const props = defineProps(['standalone', 'messages'])

function clearMessages() {
    axios
        .post(baseURL + '/api/profile/clearUserMessages', {
