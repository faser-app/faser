<template>
    <BaseModalComponent :isOpen="props.showModal" @close="$emit('close')" title="Birthday" icon="cake"
        iconBgColor="sky-950" iconBorderColor="sky-600" :error="error" submitText="Submit" animationDirection="bottom"
        submitButtonClass="bg-sky-500" @submit="addBirthday" customClass="max-h-[80svh] overflow-scroll">
