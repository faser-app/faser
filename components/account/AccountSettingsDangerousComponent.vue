<template>
    <div>
        <div class="w-full space-y-3">
            <!-- Delete Account -->
            <div
                class="setting-item rounded-lg overflow-hidden border border-red-500/30"
                :style="{ backgroundColor: currentPalette.bg }"
            >
                <div
                    class="flex justify-between items-center p-4 cursor-pointer hover:bg-red-500/10 transition-colors"
                    @click="deleteAccountModal = true"
                >
                    <div class="flex items-center gap-3">
                        <div
                            class="icon-container rounded-full w-10 h-10 flex items-center justify-center bg-red-600/80"
                        >
            ...
            >
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <p class="text-red-400 font-medium">Warning</p>
