<template>
                    ...
                    <div class="mt-3">
                        ...
                        <div class="flex gap-2">
                            <button
                                ...
                                class="px-4 py-2 rounded-md text-center w-full transition-colors duration-200"
                                :style="{
    ...
    <AccountChangeBirthdayModal
        :showModal="birthModal"
        @close="birthModal = false"
        @success="changeBirthday"
    />
    <AccountChangeBioModal
        :showModal="bioModal"
        @close="bioModal = false"
        @success="updateBio"
    />
    <AccountChangeSongModal
        :showModal="musicModal"
        :profile-selector="true"
        @close="musicModal = false"
        @success="updateSong"
    />
</template>
