        ...
        <div class="w-full">
            <div class="w-full bg-gray-800 flex flex-col">
                <div class="w-full px-2">
                    <div
                        class="flex w-full items-center text-sm p-2 py-4 rounded-md cursor-pointer text-gray-50 focus:outline-hidden">
                    ...
                    <button @click="upload" :disabled="buttonDisabled"
                        class="px-4 w-full mt-0 disabled:text-gray-500 disabled:cursor-default block p-2 text-sm border border-gray-800 rounded-md cursor-pointer bg-gray-900 text-gray-50 focus:outline-hidden">
