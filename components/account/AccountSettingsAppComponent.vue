        ...
        <div class="w-full space-y-3">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-gray-400 text-sm">
                                Show sensitive content without blurring
                            </p>
                        </div>
                    </div>
                    <div>
            ...
            >
                <div class="p-4">
                    ...
                    <div
                        class="theme-grid grid grid-cols-2 md:grid-cols-3 gap-4 mt-4"
                    >
                        <div
                        ...
                        >
                            <div
                                class="theme-circle mb-2"
                                :style="{
                                    background: linearGradient('45deg', color),
                                }"
                            ></div>
                    ...
                    <p class="text-gray-400 text-xs mt-4 italic">
                        Themes are in beta, may change or be removed, and aren't
                        fully applied yet.
                    </p>
                </div>
            </div>
            ...
            <!-- Notifications -->
            <div
                v-if="!notificationsActivated && loggedIn"
                class="setting-item rounded-lg overflow-hidden"
                :style="{ backgroundColor: currentPalette.bg }"
...
async function subscribeToPushNotifications() {
    const publicVapidKey =
        'BEPR3h9VaQvFvlh16jWSR_mODSV1hKkq2pIhRsFo5ak7GVJxrBNgndGRdbcRVSA55p8JafuN6U8h_Ct4fbZ0fdk'
    ...
    axios
        .post(baseURL + '/api/community/saveSubscription', {
...
const linearGradient = (angle, theme) => {
    const { name, displayName, textPrimary, textSecondary, ...colorValues } =
        theme
