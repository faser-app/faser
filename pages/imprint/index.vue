    ...
    <div class="min-h-[calc(100vh-4.5rem)] text-white px-5 py-6">
        <div class="imprint">
            ...
            <p>
                ...
                we cannot assume any liability for the correctness,
                completeness, or up-to-dateness of the contents. As a service
                provider, we are responsible for our own content on these pages
                in accordance with general laws as per § 7 Abs.1 TMG. According
                ...
                infringement. Upon becoming aware of such legal violations, we
                will remove this content immediately.<br /><br />
                <strong>Liability for links</strong><br /><br />
                Our offer contains links to external websites of third parties,
                the content of which we have no influence on. Therefore, we
                cannot accept any responsibility for this external content. The
                ...
                linking. A permanent control of the content of the linked pages
                is not reasonable without concrete indications of an
                infringement. If we become aware of any infringements, we will
                ...
                violations, we will remove such content immediately.<br /><br />
                <strong>Privacy</strong><br /><br />
                The use of our website is generally possible without providing
                personal data. Where personal data (such as name, address, or
                email addresses) is collected on our pages, this is always done
                on a voluntary basis, as far as possible. These data will not be
                disclosed to third parties without your explicit consent.<br />
                ...
                obligation by third parties for the purpose of sending
                unsolicited advertisements and information materials is hereby
                expressly rejected. The operators of the pages expressly reserve
                the right to take legal action in the event of unsolicited
                promotional information, such as spam emails.<br />
                <br /><br />
            </p>
            <p>
                Imprint generated with the help of
